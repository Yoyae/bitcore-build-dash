...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-monoeci/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-monoeci -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-monoeci -o bitcore-lib-monoeci.js';
    }
